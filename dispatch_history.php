...
if (isset($_POST['update'])) {
    ...
    header("Location: dispatch_history.php"); exit;
}
...
$stmt = $con->prepare("
    ...
    WHERE dj.status IN ('Completed','Cancelled')
");
$stmt->execute();
...
<div class="main-content">
  <div class="container-fluid">
    <section class="content-header">
      <h2 class="mb-4">Dispatch History</h2>
      <div class="mb-3">
        <a href="dispatch_scheduling.php" class="btn btn-primary">Dispatch Scheduling</a>
        <a href="active_jobs.php" class="btn btn-primary">Active Jobs</a>
      </div>
    </section>
        ...
        <table class="table table-bordered table-hover table-darkblue">
          <thead>
            <tr>
              ...
              <th>Date</th><th>Time</th><th>Status</th><th>Remarks</th><th>Action</th>
            </tr>
          </thead>
          <tbody>
                ...
                <div class="modal-content">
                  <form method="post">
                    <div class="modal-header">
                      <h5 class="modal-title">Edit Dispatch Job #<?= $row['id'] ?></h5>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  <form method="post">
                    ...
                    <div class="modal-body">
                      Are you sure you want to delete dispatch job <b>#<?= $row['id'] ?></b>?
                      <input type="hidden" name="id" value="<?= $row['id'] ?>">
                    </div>
                    <div class="modal-footer">
